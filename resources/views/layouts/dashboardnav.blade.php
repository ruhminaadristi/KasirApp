...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light ml-3">Kasir UMKM</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2024 Kasir UMKM Yogyakarta.</strong>
            All rights reserved.
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            //     notaWindow.document.write('<tr><td>Kasir UMKM</td></tr>');
            //     notaWindow.document.write('<tr><td>Jl. Lowanu No.34-33, Sorosutan, Kec. Umbulharjo, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55153</td></tr></table>');
            ...
            function cetakNota(shoppingItems, paymentData) {
                ...
                // Header toko
                notaWindow.document.write('<p class="txt-center bold"><strong>Kasir UMKM</strong><br>');
                notaWindow.document.write('Jl. Lowanu No.34-33, Sorosutan, Kec. Umbulharjo, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55153<br>');
                notaWindow.document.write('Telp. 0822-9944-9494</p>');
